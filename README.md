...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-4aj8suw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-4aj8suw.containers.anotherwebservice.com/
...
```
git clone git@github.com:yousefalagel/container-4aj8suw.git
cd container-4aj8suw
```
...
```
docker attach container-4aj8suw
```
